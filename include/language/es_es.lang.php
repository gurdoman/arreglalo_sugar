...
$app_list_strings['moduleListSingular'] = array (
  ...
  'Campaigns' => 'Campaña',
  'Documents' => 'Documento',
  'SugarFollowing' => 'ArréglaloFollowing',
  'Sync' => 'Sincronización',
  'Users' => 'Usuario',
  'SugarFavorites' => 'ArréglaloFavorites',
);
...
$app_list_strings['dom_email_link_type'] = array (
  'sugar' => 'Cliente de correo de Arréglalo',
...
$app_strings = array (
  ...
  'LBL_POWERED_BY_SUGARCRM' => 'Arréglalo intranet',
  'LBL_PRINT' => 'Imprimir',
  'LBL_HELP' => 'Ayuda',
  ...
  'LBL_ROUTING_ACTIONS_DELETE_BEAN' => 'Eliminar Objeto Arréglalo',
  ...
  'LBL_EMAIL_ARCHIVE_TO_SUGAR' => 'Importar a Arréglalo',
  ...
  'LBL_EMAIL_ATTACHMENTS2' => 'Desde Documentos Arréglalo',
  ...
  'LBL_EMAIL_ERROR_DUPE_FOLDER_NAME' => 'Los nombres de carpetas Arréglalo deben ser únicos.',
  ...
  'LBL_EMAIL_IMPORT_EMAIL' => 'Importar en Arréglalo',
  ...
  'LBL_EMAIL_MENU_HELP_ADD_FOLDER' => 'Crear una Carpeta (remota o en Arréglalo)',
  'LBL_EMAIL_MENU_HELP_ARCHIVE' => 'Archivar estos emails en Arréglalo intranet',
  ...
  'LBL_EMAIL_MENU_HELP_DELETE_FOLDER' => 'Eliminar una Carpeta (remota o en Arréglalo)',
  ...
  'LBL_EMAIL_MENU_HELP_RENAME_FOLDER' => 'Renombrar una Carpeta (remota o en Arréglalo)',
  ...
  'LBL_EMAIL_SPACER_LOCAL_FOLDER' => '[ Carpetas de Arréglalo ]',
  'LBL_EMAIL_SUBJECT' => 'Asunto',
  'LBL_EMAIL_TO' => 'Para',
  'LBL_EMAIL_SUCCESS' => 'Éxito',
  'LBL_EMAIL_SUGAR_FOLDER' => 'CarpetaDeArréglalo',
  ...
  'ERR_POTENTIAL_SEGFAULT' => 'Se ha detectado un posible error de segmentación de Apache.  Por favor, notifique a su administrador del sistema para que le confirme este problema y lo reporte a Arréglalo intranet.',
  ...
  'ERR_NO_DB' => 'No se ha podido realizar una conexión a la base de datos. Por favor, consulte log para más detalles.',
  'ERR_DB_FAIL' => 'Error de base de datos. Por favor, consulte log para más detalles.',
  'ERR_EXTERNAL_API_403' => 'Permiso denegado. El tipo de archivo no es compatible.',
  'ERR_DB_VERSION' => 'Archivos de Arréglalo intranet {0} sólo se puede utilizar con una base de datos de Arréglalo intranet {1}.',
  'LBL_ACCOUNT' => 'Cuenta',
  ...
  'LBL_BROWSER_TITLE' => 'Arréglalo intranet',
  ...
  'LBL_SUGAR_COPYRIGHT' => '&amp;copy; 2004-2011 Arréglalo. El Programa ha sido proporcionado TAL CUAL, sin garantía de ningún tipo.  Licenciado bajo la <a href="LICENSE.txt" target="_blank" class="copyRightLink">AGPLv3</a>.<br />Arréglalo es una marca registrada de Arréglalo.  Cualquier otro nombre de compañía o producto puede ser marca registrada de las respectivas compañías con las que esté asociado.',
  'LBL_SUGAR_COPYRIGHT_SUB' => '&amp;copy; 2004-2011 <a href="http://www.arreglalo.com.mx/" target="_blank" class="copyRightLink">Arréglalo.</a> Todos los Derechos Reservados.<br />Arréglalo es una marca registrada de Arréglalo, Inc. Cualquier otro nombre de compañía o producto puede ser marca registrada de las respectivas compañías con las que esté asociado.',
  ...
  'NTC_SUPPORT_SUGARCRM' => 'Arréglalo',
  'NTC_TIME_FORMAT' => '(24:00)',
  'NTC_WELCOME' => 'Bienvenido',
  'NTC_YEAR_FORMAT' => '(aaaa)',
  'LOGIN_LOGO_ERROR' => 'Por favor, reemplace los logos de Arréglalo.',
  'ERROR_FULLY_EXPIRED' => 'La licencia de su compañía para Arréglalo ha caducado hace más de 30 días y necesita ser actualizada. Sólo los administradores podrán iniciar la sesión.',
  'ERROR_LICENSE_EXPIRED' => 'La licencia de su compañía para Arréglalo debe ser actualizada. Sólo los administradores podrán iniciar la sesión',
  'ERROR_LICENSE_VALIDATION' => 'La licencia para Arréglalo de su compañía necesita ser validada. Sólo los administradores pueden iniciar la sesión',
  ...
  'LBL_NEW_PAGE_FEEDBACK' => 'Ha creado una nueva página. Puede agregar nuevo contenido con la opción de menú Agregar Arréglalo Dashlets.',
  ...
  'LBL_MAX_DASHLETS_REACHED' => 'Ha alcanzado el máximo número de dashlets establecido por su administrador. Por favor, quite un Arréglalo Dashlet para poder agregar más.',
  'LBL_ADDING_DASHLET' => 'Agregando Arréglalo Dashlet ...',
  'LBL_ADDED_DASHLET' => 'Arréglalo Dashlet Agregado',
  'LBL_REMOVE_DASHLET_CONFIRM' => '¿Está seguro de que desea quitar el Arréglalo Dashlet?',
  'LBL_REMOVING_DASHLET' => 'Quitando Arréglalo Dashlet ...',
  'LBL_REMOVED_DASHLET' => 'Arréglalo Dashlet Quitado',
  ...
  'LBL_RELOAD_PAGE' => 'Por favor, <a href="javascript: window.location.reload()">recargue la ventana</a> para usar este Arréglalo Dashlet.',
  ...
  'LBL_PORTAL_WELCOME_TITLE' => 'Bienvenido a Arréglalo Portal 5.1.0',
  'LBL_PORTAL_WELCOME_INFO' => 'El Portal de Arréglalo es un marco que proporciona en tiempo real punto de vista de los casos, los errores y boletines de noticias a los clientes, etc. Se trata de una interfaz externa de Arréglalo que se puede implementar en cualquier sitio web. Manténgase atento a las características de servicio al cliente como el auto de Gestión de Proyectos y foros en nuestras futuras versiones.',
  'LBL_LIST' => 'Lista',
  ...
  'ERR_SUHOSIN' => 'El flujo de subida está bloqueado por Suhosin, añade un "upload" en suhosin.executor.include.whitelist (Ver log para más información)',
...
$app_strings['LBL_EMPTY_REQUIRED_VCARD'] = 'La vCard no tiene todos los campos requeridos para este módulo. Por favor consulte log para más detalles.';
...
$app_strings['LBL_VCARD_ERROR_DEFAULT'] = 'Hubo un error subiendo el archivo vCard. Por favor consulte log para más detalles.';
$app_strings['ERROR_LICENSE_FULLY_EXPIRED'] = 'La Suscripción de su Companía al Producto Arréglalo ha expirado y necesita ser renovada. Sólo los administradores pueden ingresar cuando expiró una Suscripción. Si tiene alguna inquietud, por favor contacte con su administrador.';
