...
echo '<link rel="stylesheet" type="text/css" media="all" href="'.getJSPath('custom/themes/Suite7/css/login.css').'">';
...
$login_image = '<IMG src="'.$login_image_url.'" alt="Arréglalo" style="margin: 5px 0;">';
