 ...
 * PLACE ANY CUSTOMIZATIONS IN vntas_Proveedores
 */

require_once('include/SugarObjects/templates/company/Company.php');

class vntas_Proveedores_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'vntas_Proveedores';
	var $object_name = 'vntas_Proveedores';
	var $table_name = 'vntas_proveedores';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function vntas_Proveedores_sugar(){	
		parent::Company();
	}
