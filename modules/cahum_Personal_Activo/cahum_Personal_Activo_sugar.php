 ...
 * PLACE ANY CUSTOMIZATIONS IN cahum_Personal_Activo
 */

require_once('include/SugarObjects/templates/person/Person.php');

class cahum_Personal_Activo_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'cahum_Personal_Activo';
	var $object_name = 'cahum_Personal_Activo';
	var $table_name = 'cahum_personal_activo';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function cahum_Personal_Activo_sugar(){	
		parent::Person();
	}
