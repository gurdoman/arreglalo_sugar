 ...
 * PLACE ANY CUSTOMIZATIONS IN mkt_Franquicitarios
 */

require_once('include/SugarObjects/templates/person/Person.php');

class mkt_Franquicitarios_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'mkt_Franquicitarios';
	var $object_name = 'mkt_Franquicitarios';
	var $table_name = 'mkt_franquicitarios';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function mkt_Franquicitarios_sugar(){	
		parent::Person();
	}
