 ...
 * PLACE ANY CUSTOMIZATIONS IN cahum_Personal_Flotante
 */

require_once('include/SugarObjects/templates/person/Person.php');

class cahum_Personal_Flotante_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'cahum_Personal_Flotante';
	var $object_name = 'cahum_Personal_Flotante';
	var $table_name = 'cahum_personal_flotante';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function cahum_Personal_Flotante_sugar(){	
		parent::Person();
	}
