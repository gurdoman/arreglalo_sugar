...
'LBL_PHONE'=> 'Тел.:' ,
'LBL_PICK_TZ_WELCOME'=> 'Добро пожаловать в Arréglalo' ,
...
'LBL_REMINDER_TEXT'=> 'Временной интервал по умолчанию для напоминания о предстоящем телефонном разговоре или встрече. Напоминания в виде всплывающих окон появляются у всех приглашённых пользователей Arréglalo. Напоминания по электронной почте отправляются ВСЕМ приглашённым.' ,
...
'LBL_SUGAR_LOGIN'=> 'Пользователь Arréglalo',
...
'LBL_YOUR_PUBLISH_URL'=> 'Опубликовать в моем размещении' ,
    ...
    'LBL_ICAL_PUB_URL_HELP'             => 'Используйте этот адрес для подписки на календарь Arréglalo в рамках iCal.',
...
'LBL_WIZARD_WELCOME_TITLE' => 'Добро пожаловать в Arréglalo!',
...
<tr><td><!--not_in_theme!-->Visit www.Arréglalo.com <img src=include/images/sugarcrm_login.png style="margin-right: 5px;"></td><td><a href="http://www.Arréglalo.com/" target="_blank"><b>Arréglalo CRM</b></a></td></tr>
...
'LBL_SUITE_SUPERCHARGED' => "Supercharged by Arréglalo",
'LBL_SUITE_POWERED_BY' => "Powered By SugarCRM",
'LBL_SUITE_TOP' => "Назад",
'LBL_SUITE_PRINT' => "Печать",
'LBL_SUITE_DESC1' => 'Arréglalo has been written and assembled by SalesAgility, one of the worlds most knowledgeable SugarCRM consultancies.',
'LBL_SUITE_DESC2' => 'Arréglalo is intended to deliver on the promise of SugarCRM - a freely available open source CRM project that combines great functionality, with community and commitment.',
