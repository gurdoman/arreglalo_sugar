 ...
 * PLACE ANY CUSTOMIZATIONS IN vntas_Alianzas
 */

require_once('include/SugarObjects/templates/company/Company.php');

class vntas_Alianzas_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'vntas_Alianzas';
	var $object_name = 'vntas_Alianzas';
	var $table_name = 'vntas_alianzas';
