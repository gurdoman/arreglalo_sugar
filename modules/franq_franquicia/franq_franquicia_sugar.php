 ...
 * PLACE ANY CUSTOMIZATIONS IN franq_franquicia
 */

require_once('include/SugarObjects/templates/company/Company.php');

class franq_franquicia_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'franq_franquicia';
	var $object_name = 'franq_franquicia';
	var $table_name = 'franq_franquicia';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $estatus;
		function franq_franquicia_sugar(){	
		parent::Company();
	}
