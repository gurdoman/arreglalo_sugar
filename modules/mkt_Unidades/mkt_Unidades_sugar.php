 ...
 * PLACE ANY CUSTOMIZATIONS IN mkt_Unidades
 */

require_once('include/SugarObjects/templates/company/Company.php');

class mkt_Unidades_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'mkt_Unidades';
	var $object_name = 'mkt_Unidades';
	var $table_name = 'mkt_unidades';
