...
$mod_strings = array (
  ...
  'LBL_MAILMERGE_DESC' => 'Esta opción debería marcarse sólo si tiene el complemento Arréglalo para Microsoft&reg; Word&reg;.',
  ...
  'LBL_PORTAL_ON_DESC' => 'Permite a los usuarios administrar información del portal de usuario relativa a los registros de los contactos. Los usuarios del Portal pueden acceder a Casos, Incidencias, artículos de la Base de Conocimiento y otros datos a través de la aplicación de Portal Arréglalo.',
  ...
  'CURRENT_LOGO_HELP' => 'Este logo se muestra en la esquina superior izquierda de la aplicación Arréglalo.',
  ...
  'MAX_DASHLETS' => 'Máximo número de Arréglalo Dashlets en la Página de Inicio',
  ...
  'LBL_LDAP_ADMIN_USER_DESC' => 'Utilizado para buscar el usuario Arréglalo. [Es posible que tenga que ser totalmente calificado] La conexión será anónima si no se provee.',
  ...
  'LBL_LDAP_GROUP_NAME_DESC' => 'Ejemplo: cn=arreglalo',
  'LBL_LDAP_USER_DN_DESC' => 'Ejemplo: ou=gente,dc=ejemplo,dc=com',
  'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'Si un usuario autenticado no existe, se creará uno en Arréglalo.',
  ...
  'SHOW_DOWNLOADS_TAB_HELP' => 'Cuando se selecciona, la pestaña de descarga aparecerá en la configuración del usuario y ofrecer a los usuarios el acceso a los plug-ins y otros archivos de Arréglalo disponibles',
  ...
  'PDF_SMALL_HEADER_LOGO_INFO' => 'Esta imagen aparece en la Cabecera por defecto de los Documentos PDF de Informes.<br> Esta imagen también aparece en la esquina superior izquierda de la aplicación Arréglalo.',
  ...
  'LBL_STATUS_FONT_SUCCESS' => 'ÉXITO : La fuente ha sido añadida a Arréglalo.',
  ...
  'LBL_WIZARD_WELCOME_TITLE' => '¡Bienvenido a Arréglalo!',
  'LBL_WIZARD_WELCOME' => 'Haga clic en <b>Siguiente</b> para establecer una imagen de marca, localizar y configurar Arréglalo ahora. Si desea configurar Arréglalo más tarde, haga clic en <b>Saltar</b>.',
  ...
  'LBL_WIZARD_SYSTEM_DESC' => 'Proporcione el nombre y logo de su organización para establecer la imagen de su marca en Arréglalo.',
  'LBL_WIZARD_LOCALE_DESC' => 'Especifique cómo desea que los datos sean mostrados en Arréglalo, basándose en su ubicación geográfica. La configuración que proporcione aquí será la utiliza por defecto. Los usuarios podrán establecer sus propias preferencias.',
  'LBL_WIZARD_SMTP_DESC' => 'Proporcione la cuenta de correo que se utilizará para enviar correos, como las notificaciones de asignación y las contraseñas de nuevos usuarios. Los usuarios recibirán correos de Arréglalo, como si hubieran sido enviados desde la cuenta de correo especificada.',
  'LBL_MOBILE_MOD_REPORTS_RESTRICTION' => '* El módulo de Informes sólo está disponible para el cliente de iPhone Arréglalo Mobile.',
